...
class Coords: #Размещение спрайтов на экране
...
class StickFigureSprite(Sprite):
	def __init__(self, game):
		Sprite.__init__(self, game)
		self.images_left = [
			PhotoImage(file="stickfigure/figure-L1.gif"), #Загрузка изображений фигурки
			PhotoImage(file="stickfigure/figure-L2.gif"),
			PhotoImage(file="stickfigure/figure-L3.gif")
		]
		self.images_right = [
			PhotoImage(file="stickfigure/figure-R1.gif"),
			PhotoImage(file="stickfigure/figure-R2.gif"),
			PhotoImage(file="stickfigure/figure-R3.gif")
		]
		...
		game.canvas.bind_all('<KeyPress-Left>', self.turn_left) #Привязка к клавишам
